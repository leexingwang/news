package com.topnewgrid.bean;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import com.topnewgrid.dao.ChannelDao;
...
//		defaultOtherChannels.add(new ChannelItem(18, "数码", 11, 0));
		for (int i = 1; i < 11; i++) {
			defaultUserChannels.add(new ChannelItem(i, "我的"+i, i, 0));
		}
		for (int i = 1; i < 11; i++) {
			defaultOtherChannels.add(new ChannelItem(i, "更多"+i, i, 0));
		}
	}
